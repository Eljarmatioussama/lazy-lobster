...
import { View, ScrollView, Dimensions, Alert, BackHandler, Platform } from 'react-native'; import { SafeAreaView } from 'react-native-safe-area-context';
...
export default function Timer(props) {
    ...
    Alert.alert(
      ...
      [
        ...
        { text: Strings.ST126, onPress: closeTimer }
      ],
      { cancelable: false }
    );
    ...
    const buttonCloseColor = () => {
      return (
        <IconButton icon={"window-close"} iconColor={ColorsApp.PRIMARY} style={{marginLeft:15}} size={24} onPress={() => confirmClose()}/>
        )
    };
