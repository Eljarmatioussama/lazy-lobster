...
// Kept atomic: a failure between the delete and the inserts would otherwise
// leave the exercise with no bodyparts, which hides it from every listing query.
...
header('Location: ' . (!empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : SITE_URL . '/controller/exercises.php'));
exit;
